...
public class main {
	...
	public static void main(String[] args) throws Exception {
		...
		ArrayList<Autor> autores = criarAutores("joão");
		String fileLocation = "C:/Users/Administrator/Documents/projetosProgamacao/salvarObjeto/objetoSalvo.txt";
	...
	public static ArrayList<Autor> criarAutores(String nomeAutor1) {
		try {
			ArrayList<Autor> autores = new ArrayList<Autor>() {
				{
					add( new Autor(nomeAutor1));
				};
			};
